...
function initDashboardPage() {
  ...
  const orderCards = dashboardPage.querySelectorAll(".order-card");
  ...
  const statOrders = dashboardPage.querySelector(".card:nth-child(1) h3");
  const statPending = dashboardPage.querySelector(".card:nth-child(2) h3");
